...
<style>
  .form-control
 {
  ...
  .bg{
    background: linear-gradient(to top left, #ffffff 0%, #993399 100%);
}
}
...
<div class="container">
	<div class="jumbotron">
      ...
      <button type="button" name="insertdata" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                ADD DATA  <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
